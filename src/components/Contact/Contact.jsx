    ...
    <div id="contact">
      <div id="heading">
        ...
        <p className="paragraph">
          If you are facing some issue or you want to contact our support team
          you can reach out to us by any of these mediums.
        </p>
      </div>
      <div class="card-container">
        <div class="card">
          <div className="popup">
            ...
            <h2>Our Address</h2>
            <p className="paragraph">
              131 / B, New Link Rd, Chakala, Andheri East, Mumbai, Maharashtra
              400099
            </p>
          </div>
        </div>
        ...
        <div class="card">
          <div className="popup">
            ...
            <h2>Call Us</h2>
            <p className="paragraph">+91 7420987728</p>
          </div>
        </div>
      </div>
    </div>
